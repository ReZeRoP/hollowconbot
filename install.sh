#!/usr/bin/env bash
# =============================================================================
#  HollowConBot — Automated Installation & Configuration Script
...
# ── Variables ────────────────────────────────────────────────────────────────
REPO_URL="https://github.com/ReZeRoP/HollowConBot"
...
LOG_FILE="/var/log/hollowconbot-install.log"
...
cat << 'EOF'
  ...
  Automated Setup — github.com/ReZeRoP/HollowConBot
EOF
echo ""
}
...
[Unit]
Description=HollowConBot — Telegram Bot
...
print_summary() {
    ...
    if [[ "$SETUP_WEBAPP" == "yes" ]]; then
        ...
        if [[ "$PROTO" == "https" ]]; then
            ...
            echo -e "  ${YELLOW}   (HollowConBot also sets this automatically on every bot restart.)${NC}"
